// concentrate_tray_common — constants and geometry for the jar tray.
//
// NO TOP-LEVEL GEOMETRY. The part file calls tray_jars(); this one only defines
// it, so a coupon can include the constants without also emitting a whole tray.
// Including a file that calls its own module is how the first cut of the coupon
// came out as the full 197 mm tray.
//
