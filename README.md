...
| <img src="wolfbox-nozzles/preview.png" width="150"> | [**Wolfbox MF50 nozzle bin**](wolfbox-nozzles/) | 4×2 with eight octagonal pockets for the aftermarket nozzle set, sized from calipered nozzles with 0.1 mm a side of clearance. |
