...
| <img src="baseplates/preview.png" width="150"> | [**Baseplates**](baseplates/) | Clickfinity baseplates for the bench zones — click-latch bin retention plus edge dovetails so plates butt-and-slide to lock. 2×2 test tile, 4×4, 5×6 and 6×6. |
