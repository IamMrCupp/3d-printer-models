...
| <img src="phone-repair-consumables/preview.png" width="150"> | [**Phone-repair consumables**](phone-repair-consumables/) | 2×1 split down its length into two flat-bottomed bays: the adhesive/foam roll in one, the loose strips in the other. The ⌀92 roll bridges its bay and stands proud like a tape dispenser — the slot width holds it upright, so no cradle is needed. |
