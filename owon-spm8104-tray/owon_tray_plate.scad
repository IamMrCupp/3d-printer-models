...
//
// Part 2 of 2 — drops into the one-piece clamp frame (owon_tray_frame.scad).
// A stock 2x5 magnet-free Clickfinity baseplate (84 x 210 x 4 mm). No fasteners
// pierce it; the frame's inner lips carry it, so this stays a plain Clickfinity
